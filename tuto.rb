...
class Tuto
  def initialize
    ...
    @auth_logins = ["Chipeur", "Joker", "Arist0t3", "Bowser", "Megamind", "Farqu4d", "Mojo", "Jojo", "Dante", "Roger", "Hercule", "Drevil", "Palerme", "Rio", "1p0", "Unkn0wn", "Bogota", "Kamelot", "Nicolas", "Root", "---------APPUIE_SUR_CTRL+X_POUR_QUITTER--------"]
