...
class Tuto
  def initialize
    ...
    @auth_logins = ["Chipeur", "Joker", "Arist0t3", "Bowser", "Megamind", "Farqu4d", "Mojo", "Jojo", "Dante", "Roger", "Hercule", "Drevil", "Palerme", "Rio", "1p0", "Unkn0wn", "Bogota", "Kamelot", "---------APPUIE_SUR_CTRL+X_POUR_QUITTER--------"]
  ...
  def first_part
    ...
    introduction_str += "Votre mission est de localiser le légendaire voleur de diamant \"Charly\" et ses complices grâce à vos talents de déduction, mais aussi informatiques.\n\n"
    introduction_str += "En effet, lors de son dernier casse de la place Vendôme, ce dernier a laissé tomber son sac dans lequel se trouvait son ordinateur portable.\n\n"
    ...
    introduction_str += " - Dans un premier temps, vous devrez vous connecter à son ordinateur et vérifer qu'aucune de vos données n'ont été collectées.\n\n"
